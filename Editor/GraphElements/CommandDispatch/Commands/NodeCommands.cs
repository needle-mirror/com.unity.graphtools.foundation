...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class CollapseNodeCommand : ModelCommand<INodeModel, bool>
    {
        ...
        public static void DefaultCommandHandler(GraphToolState graphToolState, CollapseNodeCommand command)
        {
    ...
    public class ChangeNodeStateCommand : ModelCommand<INodeModel, ModelState>
    {
        ...
        /// <param name="graphToolState">The state.</param>
        /// <param name="command">The command.</param>
        public static void DefaultCommandHandler(GraphToolState graphToolState, ChangeNodeStateCommand command)
        {
            if (!command.Models.Any())
                return;
