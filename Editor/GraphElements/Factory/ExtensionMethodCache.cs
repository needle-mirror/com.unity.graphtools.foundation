...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class GraphElementsExtensionMethodsCacheAttribute : Attribute
    {
        ...
        {
            Assert.IsTrue(typeof(IModelView).IsAssignableFrom(viewDomain));
    ...
    public static class ExtensionMethodCache<TExtendedType>
    {
        ...
        /// </summary>
        /// <param name="viewDomain">The type of <see cref="IModelView"/> the extension method should apply to.</param>
        ...
        internal static Dictionary<(Type, Type), MethodInfo> BuildFactoryMethodCache(
            Func<MethodInfo, bool> filterMethods,
            Func<MethodInfo, Type> keySelector,
