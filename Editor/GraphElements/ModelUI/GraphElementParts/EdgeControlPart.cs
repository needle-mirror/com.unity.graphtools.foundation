        ...
        protected void UpdateEdgeControlColors()
        {
            ...
            else
            {
                ...
                if (edgeModel?.ToPort != null)
                    inputColor = edgeModel.ToPort.GetUI<Port>(m_OwnerElement.View)?.PortColor ?? Color.white;
                else if (edgeModel?.FromPort != null)
                    inputColor = edgeModel.FromPort.GetUI<Port>(m_OwnerElement.View)?.PortColor ?? Color.white;

                if (edgeModel?.FromPort != null)
                    outputColor = edgeModel.FromPort.GetUI<Port>(m_OwnerElement.View)?.PortColor ?? Color.white;
                else if (edgeModel?.ToPort != null)
                    outputColor = edgeModel.ToPort.GetUI<Port>(m_OwnerElement.View)?.PortColor ?? Color.white;
