...
{
    /// <summary>
    /// A part to build the UI for a port connector, a circle where the edges connect.
    /// </summary>
    public class PortConnectorPart : BaseModelUIPart
    {
        ...
        public static PortConnectorPart Create(string name, IGraphElementModel model, IModelUI ownerElement, string parentClassName)
        {
