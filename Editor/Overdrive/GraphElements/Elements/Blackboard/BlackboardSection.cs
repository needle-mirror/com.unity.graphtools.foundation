...
namespace UnityEditor.GraphToolsFoundation.Overdrive.GraphElements
{
    public class BlackboardSection : GraphElement
    {
        ...
        public delegate bool CanAcceptDropDelegate(ISelectableGraphElement selected);
        ...
        public bool CanAcceptDrop(List<ISelectableGraphElement> selection)
        {
            if (selection == null)
                return false;

            // Look for at least one selected element in this section to accept drop
            foreach (ISelectableGraphElement selected in selection)
            {
        ...
        private void OnDragUpdatedEvent(DragUpdatedEvent evt)
        {
            ...
            foreach (ISelectableGraphElement selectedElement in selection)
            {
