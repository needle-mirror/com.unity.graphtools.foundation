...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    public class ContextNode : CollapsibleInOutNode
    {
        ...
        {
            get => base.Model as IContextNodeModel;
        }
        ...
        protected override void UpdateElementFromModel()
        {
            ...
            EnableInClassList("no-vertical-input", ContextNodeModel.InputsById.Values.All(t => t.Orientation != Orientation.Vertical));
            EnableInClassList("no-vertical-output", ContextNodeModel.OutputsById.Values.All(t => t.Orientation != Orientation.Vertical));
        }
