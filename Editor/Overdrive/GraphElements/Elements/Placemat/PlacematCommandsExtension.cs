...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    static class PlacematCommandsExtension
    {
        ...
        public static void CyclePlacemat(this Placemat self, CycleDirection direction)
        {
            ...
            var placematToMoveIndex = orderedPlacemats.IndexOf(self.PlacematModel);
            ...
            {
                self.CommandDispatcher.Dispatch(
                    new ChangePlacematZOrdersCommand(
                        new[] { self.PlacematModel.ZOrder, placematToSwapWith.ZOrder },
                        new[] { placematToSwapWith, self.PlacematModel }));
            }
        }
        ...
        public static void CollapsePlacemat(this Placemat self, bool value)
        {
            ...
            self.CommandDispatcher.Dispatch(new SetPlacematCollapsedCommand(self.PlacematModel, value, collapsedModels));
        }
    }
}
