...
namespace UnityEditor.GraphToolsFoundation.Overdrive.GraphElements
{
    public class IconBadge : VisualElement
    {
        ...
        internal static readonly string iconUssClassName = ussClassName.WithUssElement("icon");
        internal static readonly string tipUssClassName = ussClassName.WithUssElement("tip");
        internal static readonly string textUssClassName = ussClassName.WithUssElement("text");
