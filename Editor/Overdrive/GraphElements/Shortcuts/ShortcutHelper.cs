...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public static class ShortcutHelper
    {
        ...
        public static void RegisterDefaultShortcuts<T>(string toolName, Func<string, bool> shortcutFilter = null) where T : GraphViewEditorWindow
        {
            ShortcutProviderProxy.GetInstance().AddTool(toolName, typeof(T), shortcutFilter);
        }
