...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    {
        internal static void DispatchDeleteSelectionCommand(this GraphView self, string operationName = "Delete")
        {
            self.CommandDispatcher.Dispatch(new DeleteElementsCommand(self.GetSelection()) { UndoString = operationName });
        }

        internal static void DispatchFrameAllCommand(this GraphView self)
        {
        ...
        internal static void DispatchFrameSelectionCommand(this GraphView self)
        {
            ...
            if (graphElements.Count > 0)
                DispatchFrameAndSelectElementsCommand(self, false, graphElements.ToArray());
        }
