...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    {
        static GraphProcessingOptions GetGraphProcessingOptions(TracingControlStateComponent tracingControlState)
        {
            ...
            if (tracingControlState.TracingEnabled)
        ...
        public static GraphProcessingResult ProcessGraph(this IGraphModel graphModel, PluginRepository pluginRepository, RequestGraphProcessingOptions options, TracingControlStateComponent tracingControlStateComponent)
        {
            ...
            {
                var graphProcessingOptions = GetGraphProcessingOptions(tracingControlStateComponent);
