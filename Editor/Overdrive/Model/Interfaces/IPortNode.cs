...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public interface IPortNodeModel : INodeModel
    {
        ...
        /// <summary>
        /// Gets the capacity of a port model on this node.
        /// </summary>
        /// <param name="portModel">The model of the port to check.</param>
        /// <returns>The capacity of the port model.</returns>
        ...
        IPortModel CreatePort(Direction direction, Orientation orientation, string portName, PortType portType,
        ...
        void DisconnectPort(IPortModel portModel);

        /// <summary>
        /// Deletes all the edges connected to a given port and potentially remove the port from the node.
        /// </summary>
        /// <param name="portModel">The port model to disconnect / remove.</param>
        /// <param name="removeFromOrderedPorts">Whether or not to remove the port from the node.</param>
        [Obsolete("Use DisconnectPort instead.")]
        void DeletePort(IPortModel portModel, bool removeFromOrderedPorts);
    }
