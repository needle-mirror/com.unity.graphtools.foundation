...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public interface IStencil
    {
        ...
        /// <summary>
        /// Computes the searcher window rect and left right ratio for a new searcher window given a usage.
        /// </summary>
        ...
        /// <param name="usage">A string for the usage of the searcher. Can be a value in SearcherService. Usage or tool specific.</param>
        Rect GetSearcherRect(Vector2 position, out float rightLeftRatio, string usage);

        // TODO JOCE This is a local setting. Should not be kept in the stencil
        /// <summary>
        /// Sets searcher window size or left-right ratio or to defines the default values for a given usage.
        /// </summary>
        /// <param name="usage">A string for the usage of the searcher. Can be a value in SearcherService. Usage or tool specific. Passing null for the usage will define the default for any searcher window.</param>
        /// <param name="size">The size of the window.</param>
        /// <param name="rightLeftRatio">The ratio between the left size and the right size (details) of the searcher.</param>
        void SetSearcherSize(string usage, Vector2 size, float rightLeftRatio = 1.0f);
