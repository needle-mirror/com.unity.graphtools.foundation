...
namespace UnityEditor.GraphToolsFoundation.Searcher
{
    class UnitySearcherExampleWindow : EditorWindow
    {
        ...
        {
            GetWindow<UnitySearcherExampleWindow>();
        }
        ...
        public void OnEnable()
        {
            ...
            titleContent = new GUIContent("Unity Searcher Example Window");
            ...
            var foodItems = new List<SearcherItem>
            {
                ...
                new SearcherItem("Weird names", "Weird names Category", new List<SearcherItem>
                {
                    new SearcherItem("CamelCase", "CamelCase Category", new List<SearcherItem>
                    {
                        ...
                        new SearcherItem("And", "Test to show that this is not parsed as a special token"),
                        new SearcherItem("Or", "Test to show that this is not parsed as a special token"),
                        new SearcherItem("Not", "Test to show that this is not parsed as a special token"),
                    }),
            ...
            searcherControl.Setup(searcher, item => { }, null);
