...
namespace UnityEditor.GraphToolsFoundation.Searcher.Tests
{
            ...
            var bookItems = new List<SearcherItem>
            {
                new SearcherItem("Books", "Books Category", new List<SearcherItem>
                {
                    new SearcherItem("Cooking", "Cooking Category", new List<SearcherItem>
                    {
                        ...
                        new SearcherItem("Middle Eastern",
                    ...
                    new SearcherItem("Science Fiction", "Science Fiction Category", new List<SearcherItem>
                    {
                        ...
                        new SearcherItem("War of the Worlds",
            ...
            var foodItems = new List<SearcherItem>
            {
                new SearcherItem("Food", "Food Category", new List<SearcherItem>
                {
                    new SearcherItem("Vegetables", "Vegetables Category", new List<SearcherItem>
                    {
                        ...
                        new SearcherItem("Broccoli",
                            "Broccoli is an edible green plant in the cabbage family whose large flowering head is eaten as a vegetable."),
                        new SearcherItem("Artichoke",
                    ...
                    new SearcherItem("Fruits", "Fruits Category", new List<SearcherItem>
                    {
                        ...
                        new SearcherItem("Tomato",
                            "The tomato (see pronunciation) is the edible fruit of Solanum lycopersicum,[2] commonly known as a tomato plant, which belongs to the nightshade family, Solanaceae.[1]"),
                        new SearcherItem("Cranberry",
                            "Cranberries are a group of evergreen dwarf shrubs or trailing vines in the subgenus Oxycoccus of the genus Vaccinium."),
                        new SearcherItem("Pumpkin",
    ...
    class SearcherTests : SearcherTestsBase
    {
        ...
        {
            return new SearcherDatabase(bookItems);
        }
        ...
        public void TestSingleTermSearch(string term, int expectedResultCount)
        {
            SingleTermSearch(term, expectedResultCount);
        }

        [TestCaseSource(nameof(MultipleTermCases))]
        public void TestMultipleTermsSearch(string term, int expectedResultCount)
        {
            MultipleTermsSearch(term, expectedResultCount);
        }
    }
}
