...
namespace UnityEditor.GraphToolsFoundation.Overdrive.Tests.GraphElements
{
    class AutoPlacementTestHelper : GraphViewTester
    {
        ...
        {
            CommandDispatcher.Dispatch(new SelectElementsCommand(SelectElementsCommand.SelectionMode.Add,
                new[] { FirstNodeModel, SecondNodeModel, ThirdNodeModel, FourthNodeModel }));
        }

        void SelectElements()
        {
            CommandDispatcher.Dispatch(new SelectElementsCommand(SelectElementsCommand.SelectionMode.Add,
                new IGraphElementModel[] { FirstNodeModel, SecondNodeModel, PlacematModel, StickyNoteModel }));
        }
