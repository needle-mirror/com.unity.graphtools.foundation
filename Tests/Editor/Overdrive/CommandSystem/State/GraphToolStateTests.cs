...
namespace UnityEditor.GraphToolsFoundation.Overdrive.Tests.CommandSystem
{
    public class GraphToolStateTests
    {
        ...
        public void SetUp()
        {
            ...
            m_Asset2 = GraphAssetCreationHelpers<TestGraphAssetModel>.CreateInMemoryGraphAsset(typeof(ClassStencil), "Test2", "Assets/Tests/test2.asset");
        }
