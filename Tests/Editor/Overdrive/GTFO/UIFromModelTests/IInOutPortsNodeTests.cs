...
namespace UnityEditor.GraphToolsFoundation.Overdrive.Tests.GTFO.UIFromModelTests
{
    public class IHasPortsTests : BaseTestFixture
    {
        ...
        public IEnumerator RevealOrderableEdgeDoesNothingIfPortIsNotReorderableEdgeReady()
        {
            ...
            CommandDispatcher.Dispatch(new SelectElementsCommand(SelectElementsCommand.SelectionMode.Replace, m_SourceNodeModel));
            yield return null;
        ...
        public IEnumerator EdgeOrderRevealedOnNodeSelection()
        {
            ...
            CommandDispatcher.Dispatch(new SelectElementsCommand(SelectElementsCommand.SelectionMode.Replace, port1Edge1));
            yield return null;
