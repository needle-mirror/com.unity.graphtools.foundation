    ...
    class GraphElementCyclingTests : GraphViewTester
    {
        ...
        public IEnumerator ElementCanBeCycledForward()
        {
            ...
            for (int i = 1; i < k_NodeCount; i++)
            {
                ...
                Assert.AreEqual(elemList[i].Model, (graphView.Selection[0] as IModelUI)?.Model);
            }
            ...
            Assert.AreEqual(elemList[0].Model, (graphView.Selection[0] as IModelUI)?.Model);
        }
        ...
        public IEnumerator ElementCanBeCycledBackward()
        {
            ...
            Assert.AreEqual(elemList[k_NodeCount - 1].Model, (graphView.Selection[0] as IModelUI)?.Model);
        }
    }
}
