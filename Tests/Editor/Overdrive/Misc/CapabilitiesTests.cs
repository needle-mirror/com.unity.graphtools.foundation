...
namespace UnityEditor.GraphToolsFoundation.Overdrive.Tests.Misc
{
    ...
    public class CapabilitiesTests
    {
        ...
        {
            // Special value attributed to NoCapabilities
            Assert.AreEqual(Int32.MinValue, Capabilities.NoCapabilities.Id);

            const int baseGtfCapsCount = 9;

            var ids = new HashSet<int>
            {
                Capabilities.NoCapabilities.Id,
