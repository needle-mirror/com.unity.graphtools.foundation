...
{
    class GraphModelDuplicationTests : BaseFixture
    {
        ...
        public void Test_CloneGraph_MiniGraph([Values] TestingMode mode)
        {
            ...
            var newGraphAsset = GraphAssetCreationHelpers<TestGraphAssetModel>.CreateInMemoryGraphAsset(CreatedGraphType, "Test_Copy", "Assets/test_copy.asset");
