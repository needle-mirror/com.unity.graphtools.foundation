...
namespace UnityEditor.GraphToolsFoundation.Overdrive.Tests.Types
{
    class CSharpTypeBasedMetadataTest
    {
        ...
        public void SetUp()
        {
            m_IntHandle = typeof(int).GenerateTypeHandle();
            m_FloatHandle = typeof(float).GenerateTypeHandle();
            m_TestMemberClassTypeHandle = typeof(TestMemberClass).GenerateTypeHandle();
        }
