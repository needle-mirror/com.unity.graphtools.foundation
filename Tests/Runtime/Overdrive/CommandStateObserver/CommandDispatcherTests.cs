...
namespace UnityEngine.GraphToolsFoundation.Overdrive.Tests.CommandSystem
{
    ...
    class CommandDispatcherTests
    {
        ...
        public void StateObserverIsNotifiedWhenObservedStateIsModified()
        {
            ...
            Assert.AreEqual(currentStateVersion, observer.GetLastObservedComponentVersion(nameof(TestGraphToolState.FooBarStateComponent)).Version);
        }
        ...
        public void StateObserverIsNotifiedWhenObservedStateIsModifiedByOtherObserver()
        {
            ...
            var initialObserverVersion = observer1.GetLastObservedComponentVersion(nameof(TestGraphToolState.FooBarStateComponent));
            ...
            Assert.AreNotEqual(initialObserverVersion, observer1.GetLastObservedComponentVersion(nameof(TestGraphToolState.FooBarStateComponent)));

            // Observer version has changed after notifying observers.
            Assert.AreNotEqual(beforeNotification, observer1.GetLastObservedComponentVersion(nameof(TestGraphToolState.FooBarStateComponent)));

            // and is equal to current state version.
            Assert.AreEqual(afterNotification, observer1.GetLastObservedComponentVersion(nameof(TestGraphToolState.FooBarStateComponent)).Version);
        }
